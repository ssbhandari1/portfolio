...
const Info = () => {
  return (
    <div className='flex flex-col gap-5 items-start'>
      ...
      <h4 >HOWDY! I'M Santosh</h4>

      <h1 className='text-2xl md:text-4xl font-extrabold leading-[1.5] ' >I'm a <br /><b className='text-secondary md:text-5xl'>MERN Stack Developer</b> <br />Based in New Delhi, India.</h1>
